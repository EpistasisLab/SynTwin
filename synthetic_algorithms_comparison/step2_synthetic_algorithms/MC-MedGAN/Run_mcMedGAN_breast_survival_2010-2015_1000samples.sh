...
for i in {0..999}; do
    ...
    python multi_categorical_gans/datasets/seerbreast/transformv2.py \
        /path_to_mc-medgan/$folder_name/$file_name.txt \
        /path_to_mc-medgan/$folder_name/$file_name.features.npz \
        /path_to_mc-medgan/$folder_name/$file_name-metadata.json \
        /path_to_mc-medgan/$folder_name/data_dimentions.csv 
    ...
    python multi_categorical_gans/datasets/train_test_split.py \
        /path_to_mc-medgan/$folder_name/$file_name.features.npz \
        0.9 \
        /path_to_mc-medgan/$folder_name/$file_name-train.features.npz \
        /path_to_mc-medgan/$folder_name/$file_name-test.features.npz
    ...
    #    /path_to_mc-medgan/$folder_name/$file_name-train.features.npz \
    #    /path_to_mc-medgan/$folder_name/$file_name-train.csv \
    #    /path_to_mc-medgan/$folder_name/$file_name-metadata.json

    #python multi_categorical_gans/datasets/seerbreast/reverse_transform_features.py \
    #    /path_to_mc-medgan/$folder_name/$file_name-test.features.npz \
    #    /path_to_mc-medgan/$folder_name/$file_name-test.csv \
    #    /path_to_mc-medgan/$folder_name/$file_name-metadata.json

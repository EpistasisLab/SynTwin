...
import sys
sys.path.insert(0, '/common/lix6/multi-categorical-gans')
...
def main():
    ...
    print(options.data,options.output_model,
        options.output_loss,
        str(options.code_size),
        str(options.batch_size),
        str(options.num_epochs),

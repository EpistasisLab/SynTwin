...
most_frequent_resolution = best_count.index[0][1]

row_with_max_value = best_df[best_df['resolution'] == most_frequent_resolution] \
    .loc[best_df[best_df['resolution'] == most_frequent_resolution]['total_patient_10_comm'].idxmax()]

# Create graph network with the best resolution and random state
best_random_state = row_with_max_value['random_state']

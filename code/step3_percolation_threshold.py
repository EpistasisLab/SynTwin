...
def step3_percolation_threshold(filepath):
    print("Running step3_percolation_threshold")
    ...
    cytoscape_df.to_csv(os.path.join(filepath,'results/percolation_threshold/cytoscape_gower_'+str(round(intersection_x,2))+'.csv'), index=False)
    ...
    print("step3_percolation_threshold completed")

    return round(intersection_x,2)